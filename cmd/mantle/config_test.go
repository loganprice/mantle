...
func (m *mockClientConfig) Solve(ctx context.Context, req client.SolveRequest) (*client.Result, error) {
	if m.err != nil {
		return nil, m.err
	}
...
func (m *mockReferenceConfig) ReadFile(ctx context.Context, req client.ReadRequest) ([]byte, error) {
	if m.data == nil {
